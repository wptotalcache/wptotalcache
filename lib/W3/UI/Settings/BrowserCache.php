    ...
    protected  function strings() {
        return array(
            ...
            'settings' => array(
                ...
                'browsercache.cssjs.w3tc' => __('Set WP Total Cache header', 'w3-total-cache'),
                ...
                'browsercache.html.w3tc' => __('Set WP Total Cache header', 'w3-total-cache'),
                ...
                'browsercache.other.w3tc' => __('Set WP Total Cache header', 'w3-total-cache'),
