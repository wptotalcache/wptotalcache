...
class W3_Plugin_NotificationsAdmin {
    ...
    public function notify_edge_mode() {
        ...
        w3_require_once(W3TC_INC_FUNCTIONS_DIR . '/admin_ui.php');
        $message = sprintf(__('<p>You can now keep WP Total Cache up-to-date without having to worry about new features breaking your website. There will be more releases with bug fixes, security fixes and settings updates. </p>
